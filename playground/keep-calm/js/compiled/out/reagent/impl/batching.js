...
var c_80218 = (a[i]);
if(cljs.core.truth_((c_80218["cljsIsDirty"]))){
(c_80218["forceUpdate"])();
} else {
}
...
var G__80222 = c;
var G__80222__$1 = (((G__80222 == null))?null:(G__80222["props"]));
if((G__80222__$1 == null)){
return null;
} else {
return (G__80222__$1["argv"]);
}
});
...
var G__80224_80225 = (c["cljsRatom"]);
if((G__80224_80225 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__80224_80225);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1487768183900