...
var o__38375__auto___91494 = (function (){var o__38375__auto__ = (function (){var o__38375__auto__ = Promise;
return goog.object.get(o__38375__auto__,"resolve").call(o__38375__auto__);
})();
return goog.object.get(o__38375__auto__,"then").call(o__38375__auto__,callback);
})();
goog.object.get(o__38375__auto___91494,"catch").call(o__38375__auto___91494,devtools.async.rethrow_outside_promise);
...
var G__91496_91497 = Error;
var target__38394__auto___91498 = G__91496_91497;
if(cljs.core.truth_(target__38394__auto___91498)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__91496_91497)].join('')),cljs.core.str("\n"),cljs.core.str("target__38394__auto__")].join('')));
}

goog.object.set(target__38394__auto___91498,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1487768199314