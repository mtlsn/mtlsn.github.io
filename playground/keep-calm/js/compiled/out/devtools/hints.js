...
var map__91849 = top_item;
var map__91849__$1 = ((((!((map__91849 == null)))?((((map__91849.cljs$lang$protocol_mask$partition0$ & (64))) || (map__91849.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__91849):map__91849);
var file = cljs.core.get.call(null,map__91849__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__91849__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__91849__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e91848){var _e = e91848;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___91851 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___91851)){
var seen_errors_91852 = temp__4655__auto___91851;
if(cljs.core.truth_(seen_errors_91852.has(self))){
} else {
seen_errors_91852.add(self);

var temp__4657__auto___91853 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___91853)){
var sense_91854 = temp__4657__auto___91853;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_91854)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1487768199917