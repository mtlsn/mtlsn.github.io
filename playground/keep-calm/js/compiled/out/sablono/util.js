...
var m__25536__auto__ = (sablono.util.to_str[goog.typeOf(x__25535__auto__)]);
if(!((m__25536__auto__ == null))){
return m__25536__auto__.call(null,x);
} else {
var m__25536__auto____$1 = (sablono.util.to_str["_"]);
...
var x__25535__auto__ = (((x == null))?null:x);
var m__25536__auto__ = (sablono.util.to_uri[goog.typeOf(x__25535__auto__)]);
if(!((m__25536__auto__ == null))){
return m__25536__auto__.call(null,x);
} else {
var m__25536__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__25536__auto____$1 == null))){
return m__25536__auto____$1.call(null,x);
} else {
...
var len__25947__auto___83320 = arguments.length;
var i__25948__auto___83321 = (0);
while(true){
if((i__25948__auto___83321 < len__25947__auto___83320)){
args__25954__auto__.push((arguments[i__25948__auto___83321]));

var G__83322 = (i__25948__auto___83321 + (1));
i__25948__auto___83321 = G__83322;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__25955__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq83319){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq83319));
});
...
var vec__83326 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__83327 = cljs.core.seq.call(null,vec__83326);
var first__83328 = cljs.core.first.call(null,seq__83327);
var seq__83327__$1 = cljs.core.next.call(null,seq__83327);
var first_word = first__83328;
var words = seq__83327__$1;
...
var G__83330 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__83330,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__83330;
}
} else {
...
var args__25954__auto__ = [];
var len__25947__auto___83333 = arguments.length;
var i__25948__auto___83334 = (0);
while(true){
if((i__25948__auto___83334 < len__25947__auto___83333)){
args__25954__auto__.push((arguments[i__25948__auto___83334]));

var G__83335 = (i__25948__auto___83334 + (1));
i__25948__auto___83334 = G__83335;
continue;
} else {
}
break;
...
var argseq__25955__auto__ = ((((0) < args__25954__auto__.length))?(new cljs.core.IndexedSeq(args__25954__auto__.slice((0)),(0),null)):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__25955__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__83331_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__83331_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__83331_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__83331_SHARP_)){
return p1__83331_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__83331_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq83332){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq83332));
});
...
var vec__83341 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__83341,(0),null);
var names = cljs.core.nth.call(null,vec__83341,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__83341,tag_name,names){
return (function (p1__83336_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__83336_SHARP_));
});})(matches,vec__83341,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__83341,tag_name,names){
return (function (p1__83337_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__83337_SHARP_));
});})(matches,vec__83341,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__83344){
var vec__83351 = p__83344;
var seq__83352 = cljs.core.seq.call(null,vec__83351);
var first__83353 = cljs.core.first.call(null,seq__83352);
var seq__83352__$1 = cljs.core.next.call(null,seq__83352);
var tag = first__83353;
var content = seq__83352__$1;
...
var vec__83354 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__83354,(0),null);
var id = cljs.core.nth.call(null,vec__83354,(1),null);
var class$ = cljs.core.nth.call(null,vec__83354,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__24872__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1487768186546