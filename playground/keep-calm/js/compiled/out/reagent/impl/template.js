...
var or__24872__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__24872__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__24872__auto__)){
return or__24872__auto__;
} else {
...
var G__80282 = o;
(G__80282[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__80283__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__80283 = function (var_args){
var args = null;
...
while (G__80284__i < G__80284__a.length) {G__80284__a[G__80284__i] = arguments[G__80284__i + 0]; ++G__80284__i;}
  args = new cljs.core.IndexedSeq(G__80284__a,0);
} 
return G__80283__delegate.call(this,args);};
G__80283.cljs$lang$maxFixedArity = 0;
G__80283.cljs$lang$applyTo = (function (arglist__80285){
var args = cljs.core.seq(arglist__80285);
return G__80283__delegate(args);
});
...
var old_80286 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_80286))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_80286)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__24860__auto__ = (node === document.activeElement);
if(and__24860__auto__){
var and__24860__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__24860__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__80289 = jsprops;
(G__80289["defaultValue"] = value);

(G__80289["onChange"] = ((function (G__80289,v,value,on_change){
return (function (p1__80287_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__80287_SHARP_);
});})(G__80289,v,value,on_change))
);
...
var vec__80293 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__80293,(0),null);
var id = cljs.core.nth.call(null,vec__80293,(1),null);
var class$ = cljs.core.nth.call(null,vec__80293,(2),null);
...
var temp__4659__auto__ = (function (){var G__80299 = cljs.core.meta.call(null,v);
if((G__80299 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__80299);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = ({"argv": v});
var G__80301_80302 = v;
var G__80301_80303__$1 = (((G__80301_80302 == null))?null:reagent.impl.template.key_from_vec.call(null,G__80301_80302));
if((G__80301_80303__$1 == null)){
} else {
(jsprops["key"] = G__80301_80303__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__80306 = cljs.core.meta.call(null,argv);
if((G__80306 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__80306);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__80307 = (((jsprops == null))?({}):jsprops);
(G__80307["key"] = key);
...
var G__80308 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__80308;
continue;
}
} else {
...
var n__25787__auto___80309 = a.length;
var i_80310 = (0);
while(true){
if((i_80310 < n__25787__auto___80309)){
(a[i_80310] = reagent.impl.template.as_element.call(null,(a[i_80310])));

var G__80311 = (i_80310 + (1));
i_80310 = G__80311;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__25787__auto___80312 = a.length;
var i_80313 = (0);
while(true){
if((i_80313 < n__25787__auto___80312)){
var val_80314 = (a[i_80313]);
if((cljs.core.vector_QMARK_.call(null,val_80314)) && ((reagent.impl.template.key_from_vec.call(null,val_80314) == null))){
(o["no-key"] = true);
} else {
}

(a[i_80313] = reagent.impl.template.as_element.call(null,val_80314));

var G__80315 = (i_80313 + (1));
i_80313 = G__80315;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__24860__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__24860__auto__){
return (ctx["no-key"]);
} else {
return and__24860__auto__;
...
var G__80317 = (cljs.core.count.call(null,argv) - first_child);
switch (G__80317) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__80317){
...
//# sourceMappingURL=template.js.map?rel=1487768184187