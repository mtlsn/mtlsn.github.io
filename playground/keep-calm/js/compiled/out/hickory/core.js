...
var m__25536__auto__ = (hickory.core.as_hiccup[goog.typeOf(x__25535__auto__)]);
if(!((m__25536__auto__ == null))){
return m__25536__auto__.call(null,this$);
} else {
var m__25536__auto____$1 = (hickory.core.as_hiccup["_"]);
...
var x__25535__auto__ = (((this$ == null))?null:this$);
var m__25536__auto__ = (hickory.core.as_hickory[goog.typeOf(x__25535__auto__)]);
if(!((m__25536__auto__ == null))){
return m__25536__auto__.call(null,this$);
} else {
var m__25536__auto____$1 = (hickory.core.as_hickory["_"]);
if(!((m__25536__auto____$1 == null))){
return m__25536__auto____$1.call(null,this$);
} else {
...
var pred__83898 = cljs.core._EQ_;
var expr__83899 = (this$["nodeType"]);
if(cljs.core.truth_(pred__83898.call(null,hickory.core.Attribute,expr__83899))){
...
var pred__83901 = cljs.core._EQ_;
var expr__83902 = (this$["nodeType"]);
if(cljs.core.truth_(pred__83901.call(null,hickory.core.Attribute,expr__83902))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_(pred__83901.call(null,hickory.core.Comment,expr__83902))){
...
if(cljs.core.truth_(pred__83901.call(null,hickory.core.Document,expr__83902))){
...
if(cljs.core.truth_(pred__83901.call(null,hickory.core.DocumentType,expr__83902))){
...
if(cljs.core.truth_(pred__83901.call(null,hickory.core.Element,expr__83902))){
...
if(cljs.core.truth_(pred__83901.call(null,hickory.core.Text,expr__83902))){
return (this$["wholeText"]);
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__83902)].join('')));
}
}
}
}
...
var temp__4657__auto__ = cljs.core.second.call(null,(function (){var or__24872__auto__ = cljs.core.re_find.call(null,/<!DOCTYPE ([^>]*)>/,s);
...
var temp__4657__auto___83904 = cljs.core.first.call(null,(doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__4657__auto___83904)){
var title_el_83905 = temp__4657__auto___83904;
if(cljs.core.empty_QMARK_.call(null,(title_el_83905["text"]))){
hickory.core.remove_el.call(null,title_el_83905);
} else {
}
} else {
}
...
var or__24872__auto__ = hickory.core.parse_dom_with_domparser.call(null,s);
if(cljs.core.truth_(or__24872__auto__)){
return or__24872__auto__;
} else {
...
//# sourceMappingURL=core.js.map?rel=1487768187443