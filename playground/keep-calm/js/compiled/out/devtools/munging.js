...
var temp__4657__auto____$1 = goog.object.get(o__38388__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__38387__auto__ = temp__4657__auto____$1;
return goog.object.get(o__38387__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__38375__auto__ = f;
return goog.object.get(o__38375__auto__,"toString").call(o__38375__auto__);
}catch (e90914){var _ = e90914;
return "";
}});
...
try{var o__38375__auto___90917 = t;
goog.object.get(o__38375__auto___90917,"cljs$lang$ctorPrWriter").call(o__38375__auto___90917,t,writer);
}catch (e90916){var __90918 = e90916;
}
...
var char_code = (function (){var o__38375__auto__ = (new String(char$));
return goog.object.get(o__38375__auto__,"charCodeAt").call(o__38375__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38375__auto__ = String;
return goog.object.get(o__38375__auto__,"fromCharCode").call(o__38375__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__90920 = num_code;
switch (G__90920) {
case (1):
return (185);
...
var o__38375__auto__ = String;
return goog.object.get(o__38375__auto__,"fromCharCode").call(o__38375__auto__,superscript_code);
});
/**
...
}catch (e90926){var e__38400__auto__ = e90926;
return false;
}})())){
...
var vec__90927 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__90927,(0),null);
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__38388__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__38388__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__38387__auto__ = temp__4657__auto____$1;
return goog.object.get(o__38387__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__25947__auto___90936 = arguments.length;
var i__25948__auto___90937 = (0);
while(true){
if((i__25948__auto___90937 < len__25947__auto___90936)){
args__25954__auto__.push((arguments[i__25948__auto___90937]));

var G__90938 = (i__25948__auto___90937 + (1));
i__25948__auto___90937 = G__90938;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__90932){
var vec__90933 = p__90932;
var ns_detector = cljs.core.nth.call(null,vec__90933,(0),null);
...
var G__90939 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__90940 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__90939;
remaining_tokens = G__90940;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq90930){
var G__90931 = cljs.core.first.call(null,seq90930);
var seq90930__$1 = cljs.core.next.call(null,seq90930);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__90931,seq90930__$1);
});
...
var vec__90948 = cljs.core.split_with.call(null,(function (p1__90944_SHARP_){
return cljs.core.not_EQ_.call(null,p1__90944_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__90948,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__90948,(1),null);
...
var vec__90954 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__90954,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__90954,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__90957 = cljs.core.rest.call(null,remaining_tokens);
var G__90958 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__90957;
name_tokens = G__90958;
continue;
} else {
...
var args90959 = [];
var len__25947__auto___90971 = arguments.length;
var i__25948__auto___90972 = (0);
while(true){
if((i__25948__auto___90972 < len__25947__auto___90971)){
args90959.push((arguments[i__25948__auto___90972]));

var G__90973 = (i__25948__auto___90972 + (1));
i__25948__auto___90972 = G__90973;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args90959.length)].join('')));
...
var vec__90962 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__90962,(0),null);
var arity = cljs.core.nth.call(null,vec__90962,(1),null);
var vec__90965 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__90965,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__90965,(1),null);
var vec__90968 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__90968,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__90968,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__90968,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__90968,(3),null);
...
var args90975 = [];
var len__25947__auto___90981 = arguments.length;
var i__25948__auto___90982 = (0);
while(true){
if((i__25948__auto___90982 < len__25947__auto___90981)){
args90975.push((arguments[i__25948__auto___90982]));

var G__90983 = (i__25948__auto___90982 + (1));
i__25948__auto___90982 = G__90983;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args90975.length)].join('')));
...
var vec__90978 = result;
var munged_ns = cljs.core.nth.call(null,vec__90978,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__90978,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__90978,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__90978,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__90978,(4),null);
var arity = cljs.core.nth.call(null,vec__90978,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__90991 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__90991,(0),null);
var args = cljs.core.nth.call(null,vec__90991,(1),null);
var vec__90994 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__90994,(0),null);
var name = cljs.core.nth.call(null,vec__90994,(1),null);
...
var G__90997 = (arity + (1));
var G__90998 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__90999){
var vec__91003 = p__90999;
var arity = cljs.core.nth.call(null,vec__91003,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__91003,(1),null);
...
return (function (p1__91006_SHARP_){
return cljs.core.get.call(null,arities,p1__91006_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__91007_SHARP_){
return cljs.core.drop.call(null,(2),p1__91007_SHARP_);
...
var args__25954__auto__ = [];
var len__25947__auto___91014 = arguments.length;
var i__25948__auto___91015 = (0);
while(true){
if((i__25948__auto___91015 < len__25947__auto___91014)){
args__25954__auto__.push((arguments[i__25948__auto___91015]));

var G__91016 = (i__25948__auto___91015 + (1));
i__25948__auto___91015 = G__91016;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__91010){
var vec__91011 = p__91010;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__91011,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq91008){
var G__91009 = cljs.core.first.call(null,seq91008);
var seq91008__$1 = cljs.core.next.call(null,seq91008);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__91009,seq91008__$1);
});
...
var G__91018 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__91018) {
...
var map__91025 = options;
var map__91025__$1 = ((((!((map__91025 == null)))?((((map__91025.cljs$lang$protocol_mask$partition0$ & (64))) || (map__91025.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__91025):map__91025);
var include_ns_QMARK_ = cljs.core.get.call(null,map__91025__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__91025__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__91025__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__91025__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__91026 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__91026,(0),null);
var fn_name = cljs.core.nth.call(null,vec__91026,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__91026,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__91026,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__91026,(4),null);
var arity = cljs.core.nth.call(null,vec__91026,(5),null);
...
var o__38375__auto__ = f;
return goog.object.get(o__38375__auto__,"getBasis").call(o__38375__auto__);
});
/**
...
}catch (e91031){var e__38400__auto__ = e91031;
...
var G__91032 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__91033 = cljs.core.rest.call(null,path);
obj = G__91032;
path = G__91033;
continue;
} else {
...
return (function (accum,p__91038){
var vec__91039 = p__91038;
var bit = cljs.core.nth.call(null,vec__91039,(0),null);
var protocol = cljs.core.nth.call(null,vec__91039,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__91042){
var vec__91046 = p__91042;
var ns = cljs.core.nth.call(null,vec__91046,(0),null);
var name = cljs.core.nth.call(null,vec__91046,(1),null);
var selector = cljs.core.nth.call(null,vec__91046,(2),null);
...
return (function (p__91054){
var vec__91055 = p__91054;
var munged_name = cljs.core.nth.call(null,vec__91055,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__91055,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__91055,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__91049_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__91049_SHARP_));
});})(name,sorted_matches,vec__91055,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1487768198291