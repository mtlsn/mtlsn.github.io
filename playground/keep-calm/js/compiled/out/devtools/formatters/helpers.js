...
var G__91060 = devtools.prefs.pref.call(null,v);
v = G__91060;
continue;
} else {
return v;
...
}catch (e91073){var e__38400__auto__ = e91073;
return false;
}})();
...
}catch (e91077){var e__38400__auto__ = e91077;
return false;
}})();
...
}catch (e91079){var e__38400__auto__ = e91079;
return false;
}}
}
});
...
var vec__91084 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__91084,(0),null);
var name = cljs.core.nth.call(null,vec__91084,(1),null);
...
return cljs.core.some.call(null,(function (p1__91087_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__91087_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1487768198398